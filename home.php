                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <div class="card">
                        ...
                        <div class="view overlay">
                            <img class="card-img-top" src="tipsimage/<?php echo $place['image']; ?>" width="60px" height="250px" alt="Card image cap">
                            <a href="#!">
                ...
                ?>
                        ...
                        <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
                            <div class="card hoverable">
                                <img class="card-img-top" src="blogimage/<?php echo $row['image']; ?>" width="60px" height="250px" alt="Card image cap">
                                <div class="card-body">
