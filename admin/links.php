    ...
    <div class="modal fade" id="imageupload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <input   class="form-control mb-4" name="link" placeholder="Link">



    <button class="btn btn-info btn-block" name="usefullink" type="submit">Save</button>
                ...
                <div class="col-lg-12 col-md-6 mb-4">
                    ...
                    <div class="media white z-depth-1 rounded">
                        ...
                        <div class="media-body p-1">
                            <p class="text-uppercase text-muted mb-1"><small>Total Links</small></p>
                            <h5 class="font-weight-bold mb-0">2 </h5>
                        </div>
                        <button type="button" href="" data-toggle="modal" data-target="#imageupload" class="btn btn-primary">Add New Link</button>
                    </div> 
                    ...
                    <section>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="text-center font-weight-bold mb-4">All Links</h5>
                                      ...
                                      while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <button type="button" href="" data-toggle="modal" data-target="#tipsdelete<?php echo $row['link_id'];?>" class="btn btn-danger float-right">Delete</button>
                                            </h6>
                            ...
                            <div class="modal fade" id="tipsdelete<?php echo $row['link_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
